...
# 1st image
        img=Image.open(r"C:\Users\Sumit Kumar\OneDrive\Desktop\Major_Project\face_recognition_system\Image\56387.jpg")
...
# 2nd image
        img1=Image.open(r"C:\Users\Sumit Kumar\OneDrive\Desktop\Major_Project\face_recognition_system\Image\3.jpg")
...
# 3rd image
        img2=Image.open(r"C:\Users\Sumit Kumar\OneDrive\Desktop\Major_Project\face_recognition_system\Image\1.jpg")
...
# back-ground image
        img3=Image.open(r"C:\Users\Sumit Kumar\OneDrive\Desktop\Major_Project\face_recognition_system\Image\back.jpg")
...
# Left_Label frame
        ...
        img_left=Image.open(r"C:\Users\Sumit Kumar\OneDrive\Desktop\Major_Project\face_recognition_system\Image\1.jpg")
...
# Current course Information
        ...
        current_course_frame.place(x=17,y=170,width=740,height=120)
...
# Course 
        ...
        course_combo["value"]=("Select Course","FE","SE","TE","BE","B.tech")
...
# Class Student Information
        ...
        class_student_frame.place(x=17,y=300,width=740,height=285)
...
# Class Division
        ...
        div_combo["value"]=("Select Semester","A","B","C")
        div_combo.current(0)
...
# Buttons Frame
        ...
        delete_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=18,font=("times new roman",13,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)


        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=18,font=("times new roman",13,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3)


        btn_frame1=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=235,width=735,height=35)

        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take a Photo Sample",width=37,font=("times new roman",13,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0)


        update_photo_btn=Button(btn_frame1,text="Reset",width=37,font=("times new roman",13,"bold"),bg="blue",fg="white")
...
# Right_Label frame
        ...
        img_right=Image.open(r"C:\Users\Sumit Kumar\OneDrive\Desktop\Major_Project\face_recognition_system\Image\1.jpg")
        ...
        search_frame.place(x=10,y=142,width=660,height=70)
        ...
        search_combo["value"]=("Select","Roll_No","Phone_ No")
        ...
        table_frame.place(x=10,y=217,width=658,height=338)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            messagebox.showerror("Error","All Fields are Required.",parent=self.root)
             ...
             try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Skp2000@",database="face_recognition")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
             ...
             try:
                ...
                if Update>0:
                     ...
                     if not Update:
                          return
                messagebox.showinfo("Success","student details successfully updated complete",parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
             except Exception as es:
...
# ============ delete function ============
    def delete_data(self):
         if self.va_std_id.get()=="":
              ...
              try:
                 delete=messagebox.askyesno("Student Delete Page","Do you want to delete this id.",parent=self.root)
                 if delete>0:
                         conn=mysql.connector.connect(host="localhost",username="root",password="Skp2000@",database="face_recognition")
                         my_cursor=conn.cursor()
                 ...
                 messagebox.showinfo("Delete","Successfully delete student details",parent=self.root)
                   ...
                   messagebox.showerror("Eroor",f"Due To:{str(es)}",self.root)
         ...
         if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
              messagebox.showerror("Error","All Fields are Required.",parent=self.root)
                ...
                try:
                        ...
                        face_classifier=cv2.CascadeClassifier("C:\\Users\\Sumit Kumar\\OneDrive\\Desktop\\Major_Project\\face_recognition_system\\haarcascade_frontalface_default.xml")
