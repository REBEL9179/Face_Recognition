...
# 1st image
        img=Image.open(r"C:Image\56387.jpg")
...
# 2nd image
        img1=Image.open(r"C:Image\3.jpg")
 ...
 #back-ground image
        img3=Image.open(r"C:Image\back.jpg")
...
# Left_Label frame
        ...
        img_left=Image.open(r"C:Image\1.jpg")
        ...
        left_inside_frame.place(x=14,y=185,width=720,height=300)
...
# Attendence id
 ...
 # Roll
        ...
        rollLabel=Label(left_inside_frame,text="Student Name:",font=("times new roman",12,"bold"),bg="white")
...
# Date label
        ...
        dateLabel=Label(left_inside_frame,text="Time:",font=("times new roman",12,"bold"),bg="white")
...
# Right_Label frame
        ...
        table_frame.place(x=10,y=5,width=657,height=480)
